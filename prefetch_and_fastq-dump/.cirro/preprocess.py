#!/usr/bin/env python3
"""
Preprocess script for SRA Prefetch and FASTQ pipeline.
Extracts uploaded files from data URLs and saves them to disk.
"""
...
def main():
    ...
    convert = ds.params.get('convert_to_fastq', False)
    print(f"Preprocessing complete: {sra_count} SRA ID(s), FASTQ conversion: {'enabled' if convert else 'disabled'}")
